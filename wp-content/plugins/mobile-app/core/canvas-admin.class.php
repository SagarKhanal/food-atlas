	...
	public static function on_admin_init() {
		...
		if (is_admin() && current_user_can( 'administrator' )) {
			if (!Canvas::get_option( 'schedule_dismiss' )) {
				add_action( 'admin_notices', array( 'CanvasAdmin', 'add_schedule_demo' ));
			}
		}
	}
...
?>
	...
	*/
	public static function push_keys_set() {
		return Canvas::get_option( 'push_app_id' ) && Canvas::get_option( 'push_key' );
	}
		...
		if (!self::push_keys_set()) {
			...
			<div class="notice is-dismissible canvas-schedule-demo-block0">
				...
				<div id="canvas_btn_div0">
					<a href="https://www.mobiloud.com/demo/" class="button button-primary canvas-schedule-demo-btn">Schedule a Demo</a>
				</div>
				<div class="clear"></div>
			</div>
			<style type="text/css">
